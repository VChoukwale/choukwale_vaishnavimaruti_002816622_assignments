 ...
 */
public class AdminCreateEmployerJPanel extends javax.swing.JPanel {
     ...
     */
    public AdminCreateEmployerJPanel(MainJFrame mainframe) {
    ...
    try {
        ...
        String sql = "INSERT INTO users (nuid, name, email, address, contact_number, profile_type, username, password) VALUES (?, ?, ?, ?, ?, ?, ?, ?)";
