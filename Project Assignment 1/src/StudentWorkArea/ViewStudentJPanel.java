...
public class ViewStudentJPanel extends javax.swing.JPanel {
     ...
     */
    public ViewStudentJPanel(MainJFrame mainframe, String selectedNUID) {
...
//        DatabaseConnection.closeConnection();
    ...
    private void initComponents() {
        ...
        txtProfileType.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Student" }));
    ...
    createuserprofile.saveUserDetails(NUID, name, email, address, contactNumber, profileType, username, password,hashedPassword);
    ...
    private void btnsaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnsaveActionPerformed
        ...
        try {
            ...
            String sql = "UPDATE users SET name = ?, email = ?, address = ?, contact_number = ?, username = ?, password = ? WHERE nuid = ?";
